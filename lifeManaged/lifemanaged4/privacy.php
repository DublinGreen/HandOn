...
<section>
	<div class="container text-justify">
		...
		Policy: <a href="https:/www.privacy policies.comilive/d1069ca8-e22f-4e94-b334-54810fb8f41d"></a>. By
		using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these

		‘Terms of Use. Please be advised the Site is hosted in _______. Ifyou access the Site from
		any other region of the world with laws or other requirements governing personal data collection,
		use, or disclosure that differ from applicable laws in _______. then through your continued
		use of the Site, you are transferring your data to _______ and you agree to have your data

		transferred to and processed in _______.
		</p>
		...
		It we terminate or suspend your account for any reason, you are prohibited from registering and
		...
		price change, suspension, or discontinuance of the Site.<br>
		...
		<h3>GOVERNING LAW</h3>
		<p>These Terms shall be governed by and defined following the laws of Egypt. Fire and yourself
		irrevocably consent that the courts of Egypt shall have exclusive jurisdiction to resolve any
		...
		<p>Any dispute arising out of or in connection with this contract, including any question regarding its
			...
			considered as the part of this clause. The number of arbitrators shall be five (5). The seat, or
			legal place, of arbitration shall be Cairo, Egypt. The language of the proceedings shall be Arabic.
			The governing law of the contract shall be the substantive law of Egypt.</p>
			...
			<p>The Parties agree that the following Disputes are not subject to the above provisions conceming
			...
			<p>There may be information on the Site that contains typographical errors, inaccuracies, or
				omissions, including descriptions, pricing, availabilty, and various other information. We reserve
				...
				<p>THE SITE IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE THAT YOUR USE OF THE SITE
					...
					DISCLAIMALL WARRANTIES, EXPRESS OR IMPLIED, IN CONNECTION WITH THE SITE AND YOUR USE
					‘THEREOF, INCLUDING, WITHOUT LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS
					FORA PARTICULAR PURPOSE, AND NON-INFRINGEMENT. WE MAKE NO WARRANTIES OR REPRESENTATIONS
					...
					MAY BE TRANSMITTED TO OR THROUGH THE SITE BY ANY THIRD PARTY, ANDIOR (6) ANY ERRORS OR
					OMISSIONS INANY CONTENT AND MATERIALS OR FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED ASA
					...
					ORANY WEBSITE OR MOBILE APPLICATION FEATURED IN ANY BANNER OR OTHER ADVERTISING, AND WE
			...
			officers, agents, partners, and employees, from and against any loss, damage, lability, claim, or demand, including
			reasonable attorieys’ fees and expenses, made by any third party due to or arising out of: (1) use of the Site; (2) breach
			of these Terms of Use: (3) any breach of your representations and warranties set forth in these Terms of Use: (4) your
			violation of the rights ofa third party, including but not limited to intellectual property rights; or (5) any overt harmful act
			...
			<h3>USER DATA</h3>
			<p>We will maintain certain data that you transmit to the Site for the purpose of managing the performance of the Site, as
			...
			<p>Visiting the Site, sending us emails, and completing online forms constitute electronic communications. You consent to
			...
			INITIATED OR COMPLETED BY US OR VIATHE SITE. You hereby waive any rights or requirements under any
			...
			retention of non-electronic records, or to payments or the granting of credits by any means other than electronic means.</p>
			<h3>MISCELLANEOUS</h3>
			<p>These Terms of Use and any policies or operating rules posted by us on the Site or in respect to the Site constitute the
			...
			extent permissible by lav. We may assign any or all of our rights and obligations to others at any time. We shall not be
			responsible or lable for any loss, damage, delay, or failure to act caused by any cause beyond our reasonable control. If
			...
			based on the electronic form of these Terms of Use and the lack of signing by the parties hereto to execute these Terms
			of Use.</p>
	</div>
