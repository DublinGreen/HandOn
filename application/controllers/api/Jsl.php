...
defined('BASEPATH') OR exit('No direct script access allowed');
 USE Aws\S3\S3Client;
class Jsl extends CI_Controller {
 ...
 public function uploadVideosNew(){
   ...
   $downloadPath = $this->addWaterMarkPrivate($videoMainPath,$watermarkPath,$usernameMall,$basenamepath);
   ...
   //  if(!empty($url1)){
   //   $data['thumbnail'] = 'http://d1q47ne2210z94.cloudfront.net/'.$_FILES['thumbnail']['name'];;
   //  }
   //  else{
   //   $data['thumbnail'] = '';
   //  }
   ...
   $url = $upload->get('ObjectURL');
   if(!empty($url)){
     $data['downloadPath'] = 'http://d2jnk8mn26fih3.cloudfront.net/'.basename($downloadPath);
   }
   else{
     $data['downloadPath'] = '';
   }
