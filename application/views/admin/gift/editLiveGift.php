						...
						<div class="box-body">
							<div class="form-group">
							  ...
							  <select class="form-control" id="sel1" name="categoryId">
									...
									<?php foreach($categoryDetails as $categoryDetailss){?>
							    	<option value="<?php echo $categoryDetailss['id']; ?>" <?php if($categoryDetailss['id'] == $details['giftCategoryId']){ echo "selected"; }?>><?php echo $categoryDetailss['title']?></option>
									<?php } ?>
							  </select>
