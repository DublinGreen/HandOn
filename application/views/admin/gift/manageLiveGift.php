		   ...
		   <!-- /.box -->
				<div class="box">
					<div class="box-header">
						<h3 class="box-title"><a href="<?= site_url();?>/Gift/addliveGift" style="font-size: 14px;" class="btn btn-block btn-success btn-xs">Add Live Gift</a></h3>
					</div>
                ...
                <th>Sound</th>
                  ...
                  <td><?php
                    ...
                    <img src="<?php echo base_url()."uploads/no_image_available.png";?>" style="width: 50px;height: 50px;">
                    <?php } else{ ?>
                    <img src="<?php echo base_url().$data['thumbnail'];?>" style="width: 50px;height: 50px;">
                  <?php } ?>
                  </td>
                                    ...
                                    <td>
                                        <?php
                                        if (empty($data['sound'])) {?>
                                            <audio controls><source src="<?php echo base_url()."uploads/no_available.mp3";?>"  type="audio/ogg" ></audio>
                                        <?php } else{ ?>
                                            <audio controls> <source src="<?php echo base_url().$data['sound'];?>" type="audio/ogg"></audio>
                                        <?php } ?>
                                    </td>
									<td>
