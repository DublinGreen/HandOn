                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" value="<?php echo $details['leval']?>" name="level" placeholder="level">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" value="<?php echo $details['expCount']?>" name="expCount" placeholder="ExpCount">
